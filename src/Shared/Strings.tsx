export default {
  ...
  Education: [
    {
      id: 1,
      title: "Certificate in Applied Web Development.",
      year: "2022 – 2023",
      school: "British Columbia Institute of Technology, Vancouver, Canada.",
    },
    {
      id: 2,
      title: "Bachelor’s Degree in Software Engineering (BS).",
      year: "2008 – 2012",
      school: "Azad University of Zanjan, Zanjan, Iran.",
    },
    {
      id: 3,
      title: "Associate Degree in Applied Software Development.",
      year: "2006 – 2008",
  ...
  Experience: [
    {
      ...
      desc: "Created multiple responsive websites for mobile and desktop devices using HTML, CSS, and React. Worked closely with senior developers to create custom and reusable components to improve application scalability.",
      descList: [
        "Implemented new features using modern javascript and React in order to swap the legacy code into modern and component based madular code to increase reusibility and user satisfaction.",
        "Helped to analyze and resolve application technical problems",
        "Work with project managers to ensure timely delivery of projects",
        "Improved website accessibility by implementing responsive design to increase mobile traffic.",
        ...
        "Assisted in the development of REST APIs, resulting in improved functionality and increased user satisfaction.",
      ],
    },
    {
      id: 2,
      ...
      descList: [
        "Reviewed designs created by UX/UI designers to ensure that they are compatible with the website’s layout or design scheme",
        "Analyze user needs and develop software solutions",
        "Helped write clean, testable code.",
        "Learned and applied new technologies and techniques, including Git version control and REST API development.",
      ],
    },
  ],
